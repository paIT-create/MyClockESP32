...
Profesjonalny zegar ścienny oparty na układzie ESP32, synchronizowany czasem NTP, wyposażony w termostat, inteligentną regulację jasności oraz rozbudowany panel konfiguracyjny "Neon-Glow".
🚀 Kluczowe cechy
...
🔧 Szybka konfiguracja
Podłącz zegar do zasilania.
Połącz się z siecią WiFi o nazwie ESP32-Clock-XXXX.
Jeśli okno konfiguracji nie pojawi się automatycznie, wpisz w przeglądarce 192.168.4.1.
Skonfiguruj swoją sieć domową i ciesz się precyzyjnym czasem.
